This project was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app), and content the Example [API Reddit](http://es.redux.js.org/docs/avanzado/ejemplo-api-reddit.html) of the [Redux docs](http://es.redux.js.org/docs/) page.
...
We are always open to [your feedback](https://github.com/flewps/react-redux-assync/issues).
...
## Install
You must be installed [node.js](https://nodejs.org/) and [npm](https://www.npmjs.com)

Open the terminal, navigate to the proyect folder and just type `npm install`
